# Welcome to the SMART Crack Contributing Guide <!-- omit in toc -->
...
## Getting Started
SMART Crack is built with React, Reaflow for visualization, Mantine UI for components, Zustand for state management. If you are not familiar with these technologies, we recommend you to read their documentation to get started. You can find the links to the respective documentations below:
...
Once you are familiar with these technologies, you can clone the SMART Crack repository by running the following command:
...
### 1. Performance
Performance is an important criteria for SMART Crack. Any new contributions should not affect the re-rendering of the application. Therefore, when making changes to the code, please keep performance in mind.
...
## Conclusion
We appreciate any contributions to SMART Crack, big or small. If you have any questions or need any help, please do not hesitate to reach out to us. Thank you for contributing!

### Your PR is merged!

Congratulations :tada::tada: The SMART Crack team thanks you :sparkles:.

Once your PR is merged, your contributions will become part of the next SMART Crack release, and will be visible in the [SMART Crack app](https://jsoncrack.com).
