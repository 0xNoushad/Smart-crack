...
const EditorPage = () => {
  ...
  return (
    <>
      <NextSeo
        {...SEO}
        title="Editor | SMART Crack"
        description="SMART Crack Editor is a tool for visualizing into graphs, analyzing, editing, formatting, querying, transforming and validating JSON, CSV, YAML, XML, and more."
